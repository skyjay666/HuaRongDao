...
class MyWindow(QMainWindow, Ui_MainWindow):
    def __init__(self):
        ...
        # 0  1  2  3
        # 上 下 左 右
        self.direction = [[-1, 0], [1, 0], [0, -1], [0, 1]]  # 方向位移
        self.step_direction = [0, 1, 2, 3]  # 位移输出
    ...
    # 改文件名/文件路径
        image_name = "./source/combine_image.bmp"       # 中间图bmp

        self.combine_image = Image.open(image_name)

        self.image = Image.open("./source/image.bmp")   # 原图bmp
